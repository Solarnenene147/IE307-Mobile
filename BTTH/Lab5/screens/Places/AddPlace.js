      ...
      <View style={styles.imageContainer}>
        ...
        {item.mediaType === MediaLibrary.MediaType.video && (
          <View style={styles.videoIcon}>
            <Icon name="play" size={50} color="white" /> {/* Biểu tượng play */}
          </View>
        )}
      </View>
    </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    ...
    alignItems: "center", // Căn giữa ảnh và biểu tượng
  },
  image: {
    width: "100%",
    height: 150,
  ...
  videoIcon: {
    ...
    left: "50%", // Đưa biểu tượng vào giữa theo chiều ngang
    transform: [{ translateX: -25 }, { translateY: -25 }], // Điều chỉnh để căn chỉnh chính xác vào giữa
