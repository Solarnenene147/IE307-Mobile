...
export default function App() {
  ...
  const toggleCheckbox = () => {
    setIsChecked(!isChecked); // Đổi trạng thái checkbox khi người dùng nhấn
  };
  return (
    <View style={styles.container}>
      <View style={styles.main}>
        ...
        <View style={styles.form}>
          <TextInput style={styles.in} placeholder='Email' placeholderTextColor={'white'}></TextInput>
          <TextInput style={styles.in} placeholder='Password' placeholderTextColor={'white'} secureTextEntry={true}></TextInput>
        </View>
